import { EventEmitter, Directive, Input, Output, HostListener, ElementRef, ɵɵdefineInjectable, Injectable, Component, ViewEncapsulation, ChangeDetectorRef, ViewChild, Injector, ReflectiveInjector, ComponentFactoryResolver, ApplicationRef, ViewContainerRef, NgModule } from '@angular/core';
...
ColorPickerService.ɵprov = ɵɵdefineInjectable({ factory: function ColorPickerService_Factory() { return new ColorPickerService(); }, token: ColorPickerService, providedIn: "root" });
