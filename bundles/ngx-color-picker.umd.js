(function (global, factory) {
    ...
    ColorPickerService.ɵprov = i0.ɵɵdefineInjectable({ factory: function ColorPickerService_Factory() { return new ColorPickerService(); }, token: ColorPickerService, providedIn: "root" });
    ...
    ColorPickerComponent.propDecorators = {
        dialogElement: [{ type: i0.ViewChild, args: ['dialogPopup', { static: true },] }],
        hueSlider: [{ type: i0.ViewChild, args: ['hueSlider', { static: true },] }],
        alphaSlider: [{ type: i0.ViewChild, args: ['alphaSlider', { static: true },] }],
    ...
    var ColorPickerDirective = /** @class */ (function () {
        function ColorPickerDirective(injector, cfr, appRef, vcRef, elRef, _service) {
            ...
            this.cpCmykColorChange = new i0.EventEmitter(true);
        ...
        ColorPickerDirective.prototype.openDialog = function () {
            if (!this.dialogCreated) {
                ...
                if (this.cpUseRootViewContainer && this.cpDialogDisplay !== 'inline') {
                    ...
                    var appInstance = this.injector.get(classOfRootComponent, i0.Injector.NULL);
                    if (appInstance !== i0.Injector.NULL) {
    ...
    ColorPickerDirective.propDecorators = {
        ...
        cpPresetColorsClass: [{ type: i0.Input }],
        ...
        cpCmykColorChange: [{ type: i0.Output }],
